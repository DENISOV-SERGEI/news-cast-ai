...
Скриншоты реальных публикаций одного прогона во всех каналах (лежат в `docs/screenshots/`):

| Канал | Скриншот |
|---|---|
| 🌐 **Сайт** (denisov-sergey.ru, секция «Новости AI») | ![Сайт: секция «Новости AI»](docs/screenshots/site-news-live.jpg) |
| ✈️ **Telegram** (посты с картинками и ссылками на источники) | ![Telegram-посты](docs/screenshots/telegram-posts.jpg) |
| 🟦 **VK** (посты в группе с хэштегами) | ![Посты в VK](docs/screenshots/vk-posts.jpg) |
| 🅳 **Яндекс Дзен** (статья «Рой агентов OpenAI…») | ![Статья в Дзене](docs/screenshots/dzen-roy-agentov.jpg) |
| 🅳 **Яндекс Дзен** (статья «Опрос: 50,5% американцев…») | ![Статья в Дзене](docs/screenshots/dzen-opros.jpg) |
